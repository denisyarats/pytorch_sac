...
AGENT_TRAIN_FORMAT = {
    ...
    'bc': [
        ...
        ('actor_loss', 'ALOSS', 'float'),
        ('actor_entropy', 'AENT', 'float'),
        ('actor_target_entropy', 'TENT', 'float'),
        ('alpha_loss', 'TLOSS', 'float'),
        ('alpha_value', 'TVAL', 'float')
    ],
    'bc_flow': [
    ...
    'bc_vae': [
        ('batch_reward', 'BR', 'float'),
        ('vae_loss', 'LOSS', 'float'),
        ('vae_recon_term', 'RLOSS', 'float'),
        ('vae_kl_term', 'KLLOSS', 'float')
    ],
    'bcq': [
        ('batch_reward', 'BR', 'float'),
        ('actor_loss', 'ALOSS', 'float'),
    ...
    'bc_sac': [
        ('critic_loss', 'CLOSS', 'float'),
        ('behavior_loss', 'BLOSS', 'float'),
        ('behavior_entropy', 'BENT', 'float'),
        ('behavior_target_entropy', 'BTENT', 'float'),
        ('alpha_loss', 'ALPHALOSS', 'float'),
        ('alpha_value', 'ALPHA', 'float'),
        ('actor_loss', 'ALOSS', 'float'),
        ('actor_eps', 'AEPS', 'float'),
        ('actor_kl', 'AKL', 'float'),
        ('nu_loss', 'NULOSS', 'float'),
        ('nu_value', 'NU', 'float'),
    ],
    'abc_sac': [
        ('critic_loss', 'CLOSS', 'float'),
        ...
        ('actor_eps', 'AEPS', 'float'),
        ('actor_kl', 'AKL', 'float'),
        ('behavior_alpha_value', 'BALPH', 'float'),
        ('policy_alpha_value', 'PALPH', 'float'),
        ('nu_value', 'NU', 'float'),
    ],
    'bcq_fuj': [
        ('batch_reward', 'BR', 'float'),
        ('pertrubator_loss', 'PLOSS', 'float'),
        ('critic_loss', 'CLOSS', 'float'),
        ('vae_loss', 'VLOSS', 'float')
    ],
    'planet': [
        ('batch_reward', 'BR', 'float'),
